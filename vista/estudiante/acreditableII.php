...
$sqlnota   = "SELECT AVG(notas.nota) AS notafinal, notas.id_inscripcion, inscripcion.id_usuario FROM notas INNER JOIN inscripcion ON notas.id_inscripcion = inscripcion.id WHERE inscripcion.id_usuario=$estudiante";
$querynota = $conexion->prepare($sqlnota);
$querynota->execute();
$saber_nota = $querynota->fetch();

if(55>$saber_nota["notafinal"]){
        ...
        <header class="page-header">
          ...
          <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Acreditables II</li>
            </ul>
        </div>
        <!-- FIN DEL HEADER -->
