                ...
                <div class="col-sm-8 ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" class="form-control" id="email1" name="email1" value="<?php echo $resultado["correo"] ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="password" class="form-control" required id="password1" name="password1" placeholder="Introduce tu contraseña" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="password" class="form-control" required id="confirm_password1" name="confirm_password1" placeholder="Confirma tu contraseña" />
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-sm-9 col-sm-offset-4">
                                <button type="submit" class="btn btn-primary" id="enviar" name="signup1" value="Sign up">Actualizar</button>
