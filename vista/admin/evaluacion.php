 ...
 <div class="page">
     ...
     <div class="page-content d-flex align-items-stretch">
       ...
       <div class="content-inner">
             ...
             <div class="container-fluid">
               <h2 class="no-margin-bottom">Cargar plan de evaluación</h2>
             </div>
           </header>
          <!-- Historial -->
          <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Cargar plan de evaluación</li>
            </ul>
          </div>
            ...
            <table id="Tablausuarios" class="table table-striped table-bordered text-center">
                  <thead>
                      <tr>
                          ...
                          <th>Tipo</th>
                          <th>Sección</th>
                          <th>Cargar plan de evaluación</th>
                      </tr>
                  </thead>
                  <tbody>
                      <?php 
                      ...
                      ?>
                              <tr>
                                  ...
                                  <td> <a href="plan_evaluacion.php?id=<?php echo $dato["id_acreditable"] ?>" title="Cargar plan de evaluacion"><i class="fa fa-check-square-o fa-lg"></i></a> </td>
                              </tr>
                      <?php 
                          endforeach 
                      ?>
