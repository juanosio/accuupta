 ...
 <div class="page">
     ...
     <div class="page-content d-flex align-items-stretch">
       ...
       <div class="content-inner">
             ...
             <div class="container-fluid">
               <h2 class="no-margin-bottom">Cambiar privilegio de usuarios</h2>
             </div>
           </header>
            <!-- Historial -->
          <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Cambiar Privilegio</li>
            </ul>
          </div>
                  ...
                  <tbody>
                      ...
                      ?>
                              <tr>
                                  ...
                                  <td>
                                    <?php 
                                      if ($dato["privilegio"]==1){
                                        echo "Administrador";
                                      } else { 
                                      if($dato["privilegio"]==2){
                                        echo "Estudiante";
                                      }  else { 
                                        if($dato["privilegio"]==3){
                                          echo "Profesor";
                                        }  else { 
                                          if($dato["privilegio"]==4){
                                            echo "Becario";
                                          }  
                                        }
                                      }
                                  ...
                                  <td> <a href="modificar_estudiante.php?id=<?php echo $dato["id"] ?>" title="Cambiar privilegio"><i class="fa fa-edit fa-lg"></i></a> </td>
                              </tr>
                      <?php 
                          endforeach 
                      ?>
